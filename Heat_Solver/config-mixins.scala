          ...
          tileParams = BoomTileParams(
            core = BoomCoreParams(
              ...
              issueParams = Seq(
                ...
                IssueParams(issueWidth=3, numEntries=8, iqType=IQT_FP.litValue , dispatchWidth=1)),
              numIntPhysRegisters = 36,
            ...
            dcache = Some(
              DCacheParams(rowBits = site(SystemBusKey).beatBits, nSets=64, nWays=4, nMSHRs=4, nTLBWays=8)
            ),
            icache = Some(
